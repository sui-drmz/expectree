...
export type EvaluationSnapshot = AndSnapshot | OrSnapshot | NotSnapshot | GroupSnapshot | ExpectationSnapshot | RootSnapshot;
/**
 * A map of expectation IDs to their statuses
 */
export type EvaluationMap = Map<ExpectationNode['id'], NodeStatus>;
export declare function snapshotIsBinary(snapShot: EvaluationSnapshot): snapShot is AndSnapshot | OrSnapshot;
export declare function snapshotIsUnary(snapShot: EvaluationSnapshot): snapShot is NotSnapshot | GroupSnapshot;
