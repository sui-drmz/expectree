import { StateAction, ExpectationRuntime } from './types';
 ...
 */
function createDefaultStatusMap(tree: RootNode): Map<string, NodeStatus> {
...
function applyUpdate(
  state: ExpectationRuntime,
  updates: Partial<Pick<ExpectationRuntime, 'tree' | 'statusMap'>>
): ExpectationRuntime {
